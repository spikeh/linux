...
#define FBNIC_TCE_TCAM_LAST_ENTRY \
	(FBNIC_TCE_TCAM_NUM_ENTRIES - 1)
...
enum {
	...
	FBNIC_MAC_ADDR_T_OTHER		= 1,	/* TBD: Possibly firmware? */
...
#define FBNIC_RPC_TCAM_ACT3_TCP_OPT_VALID	CSR_GENMASK(13, 12)
